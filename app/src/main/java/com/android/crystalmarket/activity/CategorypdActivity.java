...
public class CategorypdActivity extends Activity {
    private static final String TAG = CategorypdActivity.class.getSimpleName();
    private static final String URL = URL_category;

    private RecyclerView recyclerView;
    private List<Product> productList;
    private CategorypdActivity.StoreAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new StoreAdapter(getApplicationContext(), productList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new CategorypdActivity.GridSpacingItemDecoration(2, dpToPx(8), true));
    ...
    class StoreAdapter extends RecyclerView.Adapter<CategorypdActivity.StoreAdapter.MyViewHolder> {
        ...
        @Override
        public CategorypdActivity.StoreAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.product_item, parent, false);

            return new CategorypdActivity.StoreAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(CategorypdActivity.StoreAdapter.MyViewHolder holder, final int position) {
